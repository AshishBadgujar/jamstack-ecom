            ...
            <form className="bg-white shadow-md  px-8 pt-6 pb-8 mb-4">
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className="shadow appearance-none border w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="authcode" type="authcode" />
              </div>
